...
[![Run on Brainlife.io](https://img.shields.io/badge/Brainlife-brainlife.app.378-blue.svg)](https://doi.org/https://doi.org/10.25663/brainlife.app.378)

# Compute tSNR of DMRI Images

This app will This app will compute the temporal signal-to-noise ratio (tSNR) across the volumes of a DMRI image. This app uses FSL and follows code outlined by the Human Connectome Minimal Preprocessing Pipeline for DMRI data.
...
You can submit this App online at [https://doi.org/https://doi.org/10.25663/brainlife.app.378](https://doi.org/https://doi.org/10.25663/brainlife.app.378) via the 'Execute' tab.
...
The main output of this App is a snr datatype containing the snr images and a raw datatype containing all of the derivatives generated during this app.
